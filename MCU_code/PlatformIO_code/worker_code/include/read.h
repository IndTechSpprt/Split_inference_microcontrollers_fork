...
#include "filesys.h"
#if STATIC_LENGTHS
  const int input_length[53] = {151875, 51993, 401408, 200704, 153237, 301056, 75264, 60561, 451584, 75264, 58491, 112896, 25088, 21609, 150528, 25088, 21609, 150528, 25088, 20193, 37632, 12544, 12297, 75264, 12544, 12297, 75264, 12544, 12297, 75264, 12544, 12297, 75264, 18816, 18441, 112896, 18816, 18441, 112896, 18816, 16209, 28224, 7840, 9729, 47040, 7840, 9729, 47040, 7840, 9729, 47040, 15680, 1280, };
  const int result_length[53] = {50177, 50177, 25089, 150529, 37633, 9409, 56449, 56449, 9409, 56449, 14113, 3137, 18817, 18817, 3137, 18817, 18817, 3137, 18817, 4705, 1569, 9409, 9409, 1569, 9409, 9409, 1569, 9409, 9409, 1569, 9409, 9409, 2353, 14113, 14113, 2353, 14113, 14113, 2353, 14113, 3529, 981, 5881, 5881, 981, 5881, 5881, 981, 5881, 5881, 1961, 7841, 126, };
#else
  #include "lengths.h"
#endif
std::vector<int> lines;
std::vector<int> coor_lines;
